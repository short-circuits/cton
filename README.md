...
If you found a typo, please fix it and send a pull request. 
タイプミスを見つけた場合は、それを修正してプルリクエストを送信してください。
Если вы обнаружили опечатку, исправьте ее и отправьте запрос на перенос. 
如果发现拼写错误，请修复它并发送拉取请求。
